...
source_folder="/Users/aqeelahmad/Desktop/AlmanaProjects/ReactNative_BoilerPlate/template/MyApp/Containers/SampleScreen"
...
if [ -d "$source_folder" ]; then
    ...
    cp -R "$source_folder" "/Users/aqeelahmad/Desktop/AlmanaProjects/ReactNative_BoilerPlate/template/MyApp/Containers/$folder_name"
    echo "Folder copied successfully!"

    # Path to the copied index.js file
    index_file="/Users/aqeelahmad/Desktop/AlmanaProjects/ReactNative_BoilerPlate/template/MyApp/Containers/$folder_name/index.js"
    ...
    saga_file="/Users/aqeelahmad/Desktop/AlmanaProjects/ReactNative_BoilerPlate/template/MyApp/Containers/$folder_name/saga.js"

    # Update the saga name in saga.js
    sed -i '' "s/SampleSaga/$saga_name/g" "$saga_file"

    # Path to the copied slice.js file
    slice_file="/Users/aqeelahmad/Desktop/AlmanaProjects/ReactNative_BoilerPlate/template/MyApp/Containers/$folder_name/slice.js"
    ...
    # Update the "name" keyword in slice.js
    sed -i '' "s/'sample'/'$slice_names'/g" "$slice_file"

    # Path to the copied selector.js file
    selector_file="/Users/aqeelahmad/Desktop/AlmanaProjects/ReactNative_BoilerPlate/template/MyApp/Containers/$folder_name/selector.js"
    ...
    sed -i '' "s/state.sample/state.$slice_names/g" "$selector_file"
